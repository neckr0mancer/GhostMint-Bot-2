...
test('Discord command definitions include the complete Milestone 10a surface', () => {
  ...
  assert.deepEqual(names, ['menu', 'wallet', 'mint', 'batch-mint', 'task', 'activity', 'pnl', 'gas', 'sniper', 'mode', 'admin', 'link', 'watch', 'social-usage', 'target-policy', 'confirm-trigger', 'trigger-audit', 'pending', 'transactions']);
