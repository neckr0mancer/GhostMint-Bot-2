...
const ADMIN_SLUGS={Overview:'',Groups:'groups',Users:'users',Effective:'effective',Presets:'presets',Owners:'owners',Wallets:'wallets'};
...
const ADMIN_MOBILE_MORE=['Effective','Presets','Owners','Wallets'];
