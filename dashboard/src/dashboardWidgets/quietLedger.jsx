...
function AdvancedRow({summaryLine,details}){const [open,setOpen]=useState(false);return <div className="dash-plain-row">
  <p>{summaryLine}</p>
  {details&&<>
    <button type="button" className="b g sm" aria-expanded={open} onClick={()=>setOpen(value=>!value)}>{open?'Hide advanced details':'Advanced details'}</button>
...
export function StatusBar({summary,go}){return <div className="dash-statusbar dash-quiet">
  ...
  <div className="dash-statusbar-wallet">
    ...
    <button className="b g" onClick={()=>go('Wallets')}>View wallets</button>
...
export function PendingQueue({summary,go}){return <section className="panel dash-quiet">
  ...
  <button className="b g" onClick={()=>go('Activity')}>View activity</button>
</section>;}
...
export function StatsStrip({summary,go}){return <section className="panel dash-quiet">
  ...
  <button className="b g" onClick={()=>go('P&L')}>View P&amp;L</button>
</section>;}
...
export function TasksSnipersSummary({summary,go}){return <section className="panel dash-quiet">
  ...
  <div className="br"><button className="b" onClick={()=>go('Tasks')}>View tasks</button><button className="b" onClick={()=>go('Snipers')}>View snipers</button></div>
</section>;}
...
export function WatchTargetSummary({summary,go}){return <section className="panel dash-quiet">
  ...
  <div className="br"><button className="b" onClick={()=>go('Watch Rules')}>View watch rules</button><button className="b" onClick={()=>go('Target Policies')}>View target policies</button></div>
</section>;}
...
export function ActivityFeed({summary,go}){return <section className="panel dash-quiet">
  ...
  <button className="b g" onClick={()=>go('Activity')}>View all activity</button>
</section>;}
